...
export const metadata = {
  title: "Discover Us | Apple Migration — About Rashmi Panwar",
  description: "About Apple Education & Immigration Consultancy and our founder Rashmi Panwar. 13+ years experience, MARA registered migration agent based in Melbourne.",
};
  ...
  return (
    <>
      ...
      <section
        ...
        style={{ background: "linear-gradient(135deg, #0a4a2e 0%, #1a6b42 60%, #2e8b5a 100%)" }}
      >
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-4">
              APPLE Education and Immigration Consultancy is an Australia-based, fast-growing consultancy, specializing in Educational and Immigration services. The company has successfully helped many individuals in various migration and admission related matters.
            </p>
            <p className="text-gray-600 text-sm leading-relaxed mb-4">
              Our outstanding service extends to supporting the end-to-end journey, from pre-departure to post-arrival assistance. We are working with many prestigious Education Providers and institutes to provide unparalleled services to our clients.
            </p>
            <p className="text-gray-600 text-sm leading-relaxed">
              We strive to provide a universal approach to Education and Migration needs by offering full range of services for new migrants as well as people locally established in Australia.
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "Our Vision",
                text: "To create Global opportunity for people and help them realise the most suitable Career Path. To make Top quality International Education accessible worldwide.",
              },
              {
                icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z",
                title: "Our Mission",
                text: "To facilitate our clients in understanding the migration processes and direct them to right career path, so they can explore global opportunities and realize their full potential.",
              },
              {
                icon: "M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z",
                title: "Our Commitment",
                text: "We aim to deliver the highest quality of services with exceptional customer service, prompt responses and greater value for our clients at every step of their journey.",
              },
            ].map(item => (
              <div key={item.title} className="bg-white rounded-xl p-5 border border-gray-100 flex gap-4 shadow-sm hover:shadow-md transition-shadow">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-[#0a4a2e] to-[#1a6b42] rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[4/5] flex flex-col items-center justify-center relative bg-gradient-to-b from-[#0a4a2e] to-[#1a6b42]">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    src="https://applemigration.com.au/wp-content/uploads/2024/07/rashmi-panwar.jpg"
                    alt="Rashmi Panwar — Founder and Director"
                    className="w-full h-full object-cover object-top"
                    onError={(e) => {
                      const t = e.currentTarget;
                      t.style.display = "none";
                      const fb = document.getElementById("director-fallback");
                  ...
                  <div
                    ...
                    style={{ display: "none" }}
                  >
                    <div className="w-32 h-32 rounded-full border-4 border-[#c8a84b]/40 bg-[#c8a84b]/20 flex items-center justify-center mb-4">
                      <span className="font-playfair text-5xl font-bold text-[#e8c96a]">RP</span>
                    </div>
                    <p className="text-white/50 text-xs text-center px-8 mt-2">
                      To show photo: add rashmi.jpg to /public/ and update src to /rashmi.jpg
                    </p>
                  </div>
                </div>
                <div className="px-6 py-5 text-center border-t border-white/10">
                  ...
                  <div className="flex justify-center gap-3 mt-4">
                    <a href="https://www.linkedin.com/in/rashmi-panwar" target="_blank" rel="noopener noreferrer"
                    ...
                    <a href="https://www.facebook.com/applemigration" target="_blank" rel="noopener noreferrer"
                      className="w-8 h-8 rounded-full bg-white/10 hover:bg-[#c8a84b] flex items-center justify-center transition-colors"
                    >
                      <svg className="w-3.5 h-3.5 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {["MARA Registered", "Migration Law Expert", "Education Specialist", "Melbourne Based", "Australia & India"].map(t => (
