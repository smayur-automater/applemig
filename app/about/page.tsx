...
export default function AboutPage() {
  ...
  return (
    <>
      ...
      {/* HERO */}
      <section className="py-16 px-6 text-white" style={{ background: "linear-gradient(135deg, #0d1b4b 0%, #1a2f7a 60%, #2040a0 100%)" }}>
        <div className="max-w-6xl mx-auto">
          <p className="text-[#e63333] text-xs uppercase tracking-widest mb-2">Home › Discover Us</p>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-3 divide-x divide-gray-100">
          {[{ num: "500+", label: "Clients Assisted" }, { num: "13+", label: "Years Experience" }, { num: "100%", label: "Dedication" }].map(s => (
            <div key={s.label} className="py-8 text-center">
              <div className="font-playfair text-4xl font-bold text-[#0d1b4b] mb-1">{s.num}</div>
      ...
      <section className="py-20 px-6 bg-[#f4f6ff]">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <p className="text-[#1a2f7a] text-xs uppercase tracking-widest font-medium mb-2">Discover Us</p>
          ...
          <div className="grid grid-cols-1 gap-4">
            {[
              ...
              <div key={item.title} className="bg-white rounded-xl p-5 border border-gray-100 flex gap-4 shadow-sm">
                <div className="w-10 h-10 rounded-full bg-[#0d1b4b]/10 flex items-center justify-center shrink-0">
                  <svg className="w-5 h-5 text-[#1a2f7a]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <p className="text-[#1a2f7a] text-xs uppercase tracking-widest font-medium mb-2">Our Leadership</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-[#0d1b4b] to-[#1a2f7a] rounded-2xl overflow-hidden shadow-2xl">
                {/* Photo area — loads from /public/rashmi.jpg */}
                <div className="aspect-[4/5] relative overflow-hidden">
                  {!photoError ? (
                    <img
                      src="/rashmi.jpg"
                      alt="Rashmi Panwar — Founder and Director, Apple Migration"
                      className="w-full h-full object-cover object-top"
                      onError={() => setPhotoError(true)}
                    />
                  ) : (
                    <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-b from-[#0d1b4b] to-[#1a2f7a] px-8 text-center">
                      <div className="w-36 h-36 rounded-full bg-white/10 border-4 border-[#cc0000]/50 flex items-center justify-center mb-5">
                        <span className="font-playfair text-5xl font-bold text-[#e63333]">RP</span>
                      </div>
                      <p className="text-white/50 text-xs leading-relaxed mt-2">
                        Save Rashmi&apos;s photo as<br />
                        <code className="bg-white/10 px-2 py-0.5 rounded text-white/80 mt-1 inline-block">public/rashmi.jpg</code><br />
                  ...
                  <div className="flex justify-center gap-3 mt-4">
                    {[
                      ...
                      <a key={i} href={s.href} target="_blank" rel="noopener noreferrer"
                        className="w-8 h-8 rounded-full bg-white/10 hover:bg-[#cc0000] flex items-center justify-center transition-colors">
              ...
              {/* Decorative blobs */}
              <div className="absolute -bottom-4 -right-4 w-24 h-24 rounded-full bg-[#cc0000]/10 -z-10" />
              <div className="absolute -top-4 -left-4 w-16 h-16 rounded-full bg-[#1a2f7a]/10 -z-10" />
            </div>

            {/* BIO */}
            <div>
              <p className="text-[#1a2f7a] text-xs uppercase tracking-widest font-medium mb-2">Meet Our Director</p>
              <h2 className="font-playfair text-3xl font-bold text-gray-900 mb-2">Rashmi Panwar</h2>
              <p className="text-[#cc0000] font-medium text-sm mb-6">Founder &amp; Director — Apple Education &amp; Immigration Consultancy</p>
              <p className="text-gray-600 text-sm leading-relaxed mb-4">
                Our director comes from a very strong background in international education. She holds an extensive <strong className="text-gray-800">13 years</strong> of experience in the Education and Migration industry. Having established strong grounding in this sector, she is well-versed with the challenges and dynamics of this industry.
              </p>
              ...
              <div className="space-y-3 mb-6">
                ...
                {[
                  ...
                  <div key={q} className="flex items-center gap-3 bg-[#f4f6ff] rounded-lg px-4 py-3 border border-gray-100">
                    <svg className="w-4 h-4 text-[#1a2f7a] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {["MARA Registered", "Migration Law Expert", "Education Specialist", "Melbourne Based"].map(t => (
                  <span key={t} className="bg-[#0d1b4b]/10 text-[#1a2f7a] text-xs px-3 py-1.5 rounded-full font-medium border border-[#1a2f7a]/15">{t}</span>
                ))}
              </div>
              <div className="grid grid-cols-2 gap-3">
                <a href="tel:+61470519421" className="flex items-center gap-3 bg-[#0d1b4b] text-white rounded-lg px-4 py-3 hover:bg-[#cc0000] transition-colors">
                  <svg className="w-4 h-4 text-[#e63333] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="mailto:visa@applemigration.com.au" className="flex items-center gap-3 bg-[#f4f6ff] border border-gray-200 text-gray-700 rounded-lg px-4 py-3 hover:border-[#1a2f7a] transition-colors">
                  <svg className="w-4 h-4 text-[#1a2f7a] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-16 px-6 bg-[#f4f6ff]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            <p className="text-[#1a2f7a] text-xs uppercase tracking-widest font-medium mb-2">Where We Are</p>
          ...
          <div className="max-w-md mx-auto bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div className="bg-[#0d1b4b] px-6 py-4">
              <p className="text-[#e63333] text-xs uppercase tracking-widest font-medium">Australia Head Office</p>
            </div>
            <div className="px-6 py-6 space-y-4">
              {[
                ...
                <div key={i} className="flex gap-3 items-start">
                  <div className="w-8 h-8 rounded-full bg-[#0d1b4b]/10 flex items-center justify-center shrink-0 mt-0.5">
